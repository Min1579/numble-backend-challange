...
@Entity
@Table(
        uniqueConstraints = @UniqueConstraint(name = "likedItem_userId_itemId_unique_constraint", columnNames = {"user_id", "item_id"}),
        indexes = @Index(name = "ix_createdAt_userId", columnList = "created_at,user_id")
)
